...
| **Phase 4.5** | **V1 wire-up 仕上げ (実 API 連携 / Artifact 統合 / テスト書き直し)** | #39 / #40 / #20 | 5 | ⬜ 未着手 |
...
### [ ] P4.5.1 — AgentsListPane の公開トグルを Anthropic API で永続化
...
### [ ] P4.5.2 — Custom skill 追加 wire-up (Worker /skills/sync 拡張 + SkillAddModal 連携)
...
### [ ] P4.5.3 — Customizer Artifact 表示時に WorkflowFooter + FileTree を統合
...
### [ ] P4.5.4 — Conversation View 内に履歴 / 新規会話 / 再連携の代替動線
...
### [ ] P4.5.5 — ChatPanel.test.tsx の 6 skip ケースを新 Header で書き直し
